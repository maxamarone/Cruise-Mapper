package eu.eurostat.trackingships.webcam.job;
...
public class CaptureImageFromWebcamAISDataJob implements Job
{
   private static final Logger LOGGER = Logger.getLogger(CaptureImageFromWebcamAISDataJob.class.getName());
