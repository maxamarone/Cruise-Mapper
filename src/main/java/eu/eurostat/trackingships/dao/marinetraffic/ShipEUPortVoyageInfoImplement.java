...
public class ShipEUPortVoyageInfoImplement implements ShipEUPortVoyageInfoInterface
{
   private static final Logger LOGGER = Logger.getLogger(ShipEUPortVoyageInfoImplement.class.getName());
      ...
      throws SQLException
   {
      ...
      try
      {
         ...
         for (ShipPortVoyageInfo shipBean : shipBeans)
         {
            ...
            stmt.setString(36, shipBean.getTrackingDate());
