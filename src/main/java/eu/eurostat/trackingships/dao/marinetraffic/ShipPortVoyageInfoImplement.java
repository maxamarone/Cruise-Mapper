...
public class ShipPortVoyageInfoImplement implements ShipPortVoyageInfoInterface
{
   private static final Logger LOGGER = Logger.getLogger(ShipPortVoyageInfoImplement.class.getName());
