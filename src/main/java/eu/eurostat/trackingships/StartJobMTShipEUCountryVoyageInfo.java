...
import eu.eurostat.trackingships.marinetraffic.job.ShipEUCountryVoyageInfoJob;
...
public class StartJobMTShipEUCountryVoyageInfo
{
   private static final Logger LOGGER = Logger.getLogger(StartJobMTShipEUCountryVoyageInfo.class.getName());
   ...
   public static void main(String[] args)
   {
      try
      {
         ...
         JobDetail job = newJob(ShipEUCountryVoyageInfoJob.class)
