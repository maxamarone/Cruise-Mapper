...
public class SearchShipGeoCoordsVoyageInfo
{
   private static final Logger LOGGER = Logger.getLogger(SearchShipGeoCoordsVoyageInfo.class.getName());
   ...
   public static void main(String[] args) throws InterruptedException
   {
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         SearchShipGeoCoordsVoyageInfo searchShip = new SearchShipGeoCoordsVoyageInfo();
      }
