...
public class ShipEUPortVoyageInfoJob implements Job
{
   private static final Logger LOGGER = Logger.getLogger(ShipEUPortVoyageInfoJob.class.getName());
           ...
           throws JobExecutionException
  {
      try
      {
         ...
         InputStream propsFile = ShipEUPortVoyageInfoJob.class.getClassLoader().getResourceAsStream("config.properties");
         ...
         String timeLastPosition = props.getProperty("time_last_position");
         //set directory name
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         ShipEUPortVoyageInfoJob searchShip = new ShipEUPortVoyageInfoJob();
   ...
   private static WebDriver intiWebClient() throws IOException
   {
      ...
      InputStream propsFile = ShipEUPortVoyageInfoJob.class.getClassLoader().getResourceAsStream("driver.properties");
      Properties props = new Properties();
      props.load(propsFile);
      ...
      propsFile = ShipEUPortVoyageInfoJob.class.getClassLoader().getResourceAsStream("proxy.properties");
