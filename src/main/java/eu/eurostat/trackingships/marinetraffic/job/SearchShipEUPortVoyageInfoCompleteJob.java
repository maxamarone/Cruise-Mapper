...
public class SearchShipEUPortVoyageInfoCompleteJob implements Job
{
   private static final Logger LOGGER = Logger.getLogger(SearchShipEUPortVoyageInfoCompleteJob.class.getName());
           ...
           throws JobExecutionException
  {
      try
      {
         ...
         InputStream propsFile = SearchShipEUPortVoyageInfoCompleteJob.class.getClassLoader().getResourceAsStream("config.properties");
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         SearchShipEUPortVoyageInfoCompleteJob searchShip = new SearchShipEUPortVoyageInfoCompleteJob();
   ...
   private static WebDriver intiWebClient() throws IOException
   {
      ...
      InputStream propsFile = SearchShipEUPortVoyageInfoCompleteJob.class.getClassLoader().getResourceAsStream("driver.properties");
      Properties props = new Properties();
      props.load(propsFile);
      ...
      propsFile = SearchShipEUPortVoyageInfoCompleteJob.class.getClassLoader().getResourceAsStream("proxy.properties");
