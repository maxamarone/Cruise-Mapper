...
public class SearchShipEUPortVoyageInfoJob implements Job
{
   private static final Logger LOGGER = Logger.getLogger(SearchShipEUPortVoyageInfoJob.class.getName());
           ...
           throws JobExecutionException
  {
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         SearchShipEUPortVoyageInfoJob searchShip = new SearchShipEUPortVoyageInfoJob();
