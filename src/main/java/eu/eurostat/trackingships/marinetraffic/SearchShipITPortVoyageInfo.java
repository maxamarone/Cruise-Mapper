...
public class SearchShipITPortVoyageInfo
{
   private static final Logger LOGGER = Logger.getLogger(SearchShipITPortVoyageInfo.class.getName());
   ...
   public static void main(String[] args) throws InterruptedException
   {
      try
      {
         ...
         for (int i = 0; i < ports.length; i++)
         {
            ...
            String urlParam3 = "&current_port_in|begins|" + ports[i] + "|current_port_in=" + codePorts[i];
            //set vessel type
            //&ship_type_in|in|Passenger%20Vessels,Cargo%20Vessels,Tankers,|ship_type_in=6,7,8
            String urlParam4 = "&ship_type_in|in|" + vesselTypeList + "|ship_type_in=" + vesselCodeTypeList;
            //time last position
            //&time_of_latest_position_between|gte|time_of_latest_position_between=1440,525600
            String urlParam5 = "&time_of_latest_position_between|gte|time_of_latest_position_between=" + timeLastPosition;
            //set url search
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         SearchShipITPortVoyageInfo searchShip = new SearchShipITPortVoyageInfo();
      }
