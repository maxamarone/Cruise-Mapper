...
public class SearchShipGeoAreaSatellite
{
   private static final Logger LOGGER = Logger.getLogger(SearchShipGeoAreaSatellite.class.getName());
   ...
   public static void main(String[] args) throws InterruptedException
   {
      ...
      catch (SessionNotCreatedException ex)
      {
         ...
         //restart search
         SearchShipGeoAreaSatellite searchShip = new SearchShipGeoAreaSatellite();
      }
